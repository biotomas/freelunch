...
public class SlidingPuzzleFormalizer implements
        PlanningProblemFormalizer<SlidingPuzzleProblem> {

    @Override
    public SasProblemBuilder formalize(SlidingPuzzleProblem problem) {
